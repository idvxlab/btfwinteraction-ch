    ...
    */
    ...
    _createCard_frontBody() {
        ...
        Homepage_Card.card_body_front_titleArray.forEach((title, i, titleList) => {
            ...
            if (i == 0) {
                card_frontBody_textHtml = `<p class="card-body-text"><b>来源: </b>${card_body_front_textArray[i]}</p>`;
                card_body_node.innerHTML += (card_frontBody_titleHtml + card_frontBody_textHtml);
                return;
            }
            if (i == 1) {
                card_frontBody_textHtml = `<p class="card-body-text"><b>年份: </b>${card_body_front_textArray[i]}</p>`;
                card_body_node.innerHTML += (card_frontBody_titleHtml + card_frontBody_textHtml);
                return;
            }
    ...
    _createCard_backTopic() {
        ...
        let back_typetitle_html = `<div class="apptitle BackBigTitle">主题</div>`;
    ...
    _createCard_backWhat() {
        ...
        let back_typetitle_html = `<div class="apptitle BackBigTitle">输入内容</div>`;
        let app_fields_node = document.createElement("div");
    ...
    _createCard_backHow() {
        ...
        let back_typetitle_html = `<div class="apptitle BackBigTitle">输入方式</div>`;
        let app_fields_node = document.createElement("div");
        let app_fields_text_html = `<span class="app-fields-text back-text-content">${this.parameters["Topic"]}</span>`;
    ...
    _createCard_backOutput() {
        ...
        let back_typetitle_html = `<div class="apptitle BackBigTitle">输出</div>`;
        let app_fields_node = document.createElement("div");
        let app_fields_text_html = `<span class="app-fields-text back-text-content">${this.parameters["Topic"]}</span>`;
